...
import { TemporaryUsernames1566459567245 } from './migrations/1566459567245-TemporaryUsernames';
...
export const connectDB = (Env: Environment) => {
  const db: MysqlConnectionOptions = {
    ...
    migrations: [UserSeed1565945881563, TemporaryUsernames1566459567245]
  };
